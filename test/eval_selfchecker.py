...
from core.evaluation.metrics.self_checker import check_llm_answer
...
print(check_llm_answer(qa_id="qa1", question=question1, ground_truth_answer=answer1, llm_answer=reasoning1))
...
print(check_llm_answer(qa_id="qa2", question=question2, ground_truth_answer=answer2, llm_answer=reasoning2))
